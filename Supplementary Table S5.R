# Supplementary Table S5. Baseline class-level ICCs for module and overall scores.
...
dir.create(file.path(script_dir, "analysis_tables", "details/Supplementary_Table_S5"), recursive = TRUE, showWarnings = FALSE)
...
supp_csv <- file.path(out_dir, "details/Supplementary_Table_S5/supp_table2_class_cluster_sensitivity.csv")
...
icc_csv <- file.path(out_dir, "Supplementary_Table_S5.csv")
write.csv(icc[icc$Outcome %in% c("score3", "score6", "score7"), ], icc_csv, row.names = FALSE)
