# Supplementary Table S11. Voluntary adoption with class-cluster-robust standard errors.
...
dir.create(file.path(script_dir, "analysis_tables", "details/Supplementary_Table_S11"), recursive = TRUE, showWarnings = FALSE)
...
out_csv <- file.path(out_dir, "Supplementary_Table_S11.csv")
write.csv(out_table[2, ], out_csv, row.names = FALSE)
...
out_details <- file.path(out_dir, "details/Supplementary_Table_S11/table4_adoption_risk_ratio_details.csv")
